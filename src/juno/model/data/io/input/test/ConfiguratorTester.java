...
public class ConfiguratorTester {
    ...
    public static void main(String[] args) {
        // TEST TARGETS
        String myClassConfigPath = PathGenerator.generate(Directories.CONFIG.absolutePath(), "my-class-config.json");
        String myObjectConfigPath = PathGenerator.generate(Directories.CONFIG.absolutePath(), "my-object-config.json");
