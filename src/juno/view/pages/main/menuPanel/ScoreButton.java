...
public class ScoreButton extends JButton {
    ...
    public void init() {
        ...
        // IMAGE SETTINGS
        String imageNF = PathGenerator.generate(Paths.BUTTONS.getPath(), "score-not-focus.png");
        String imageF = PathGenerator.generate(Paths.BUTTONS.getPath(), "score-focus.png");
