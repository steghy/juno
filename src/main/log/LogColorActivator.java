...
public class LogColorActivator {
	...
	public static void active(String[] args) {
		...
		Map<String, Optional<Object>> filteredArgs = ArgumentsFilter
				.filter(LogColorOptionsUtils.getOptions(), ArgumentsSorter.getArguments(args));
		...
		for(String option: filteredArgs.keySet()) {
			...
			LogColorEnabler.getInstance().enabled.put(LogColorOptionsUtils.getCodeFrom(option), value);
		}
	}
}
